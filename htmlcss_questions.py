...
def htmlcss_questions():
    def save_question():
        ...
        try:
            ...
            sql = "INSERT INTO htmlcssquestions (question, option1, option2, option3, option4, correct_answer) VALUES (%s, %s, %s, %s, %s, %s)"
