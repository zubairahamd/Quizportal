...
def python_questions():
    def save_question():
        ...
        try:
            ...
            sql = "INSERT INTO pythonquestions (question, option1, option2, option3, option4, correct_answer) VALUES (%s, %s, %s, %s, %s, %s)"
    ...
    # Question entry
    question_label = ctk.CTkLabel(form_frame, text="Question:", font=("Arial", 14, "bold"))
