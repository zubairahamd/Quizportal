...
def htmlcssmanagement():
    ...
    title_label = ctk.CTkLabel(
        header_frame,
        text="Html & Css Question Management Dashboard",
    ...
    def load_data():
        try:
            ...
            # Fetch all questions
            cur.execute("SELECT * FROM html_css")
            rows = cur.fetchall()
    ...
    def add_user(entries, window):
        try:
            ...
            sql = "INSERT INTO html_css (questionno, qname, opt1, opt2, opt3, opt4, correct) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    ...
    def delete_user():
        ...
        if msg.get() == "Yes":
            try:
                ...
                sql = "DELETE FROM html_css WHERE questionno=%s"
    ...
    def search_user():
        try:
            ...
            sql = "SELECT * FROM html_css WHERE qname LIKE %s OR questionno LIKE %s"
