...
def javamanagment():
    ...
    title_label = ctk.CTkLabel(
        header_frame,
        text="Java Question Management Dashboard",
    ...
    def add_user(entries, window):
        try:
            ...
            sql = "INSERT INTO java (questionno, qname, opt1, opt2, opt3, opt4, correct) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    ...
    def delete_user():
        ...
        if msg.get() == "Yes":
            try:
                ...
                sql = "DELETE FROM java WHERE questionno=%s"
    ...
    def search_user():
        try:
            ...
            sql = "SELECT * FROM java WHERE qname LIKE %s OR questionno LIKE %s"
