...
def sqlmanagment():
    ...
    def load_data():
        try:
            ...
            # Fetch all questions
            cur.execute("SELECT * FROM sql_mcq")
            rows = cur.fetchall()
    ...
    def add_user(entries, window):
        try:
            ...
            sql = "INSERT INTO sql_mcq (questionno, qname, opt1, opt2, opt3, opt4, correct) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    ...
    def delete_user():
        ...
        if msg.get() == "Yes":
            try:
                ...
                sql = "DELETE FROM sql_mcq WHERE questionno=%s"
    ...
    def search_user():
        try:
            ...
            sql = "SELECT * FROM sql_mcq WHERE qname LIKE %s OR questionno LIKE %s"
